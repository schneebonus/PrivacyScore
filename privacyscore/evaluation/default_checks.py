...
CHECKS['privacy']['webserver_locations']['longdesc'] = '''<p>We obtain the IP addresses of the domain and look up its country in a GeoIP database. It is believed that personal data is protected better, if a website is hosted in a country that implements the European General Data Protection Directive (GDPR). We plan to offer more flexible geo-location tests in the future.</p>
<p><strong>Conditions for passing:</strong> The test passes if all IP addresses (A records) are found to be in countries that implement the GDPR.</p>
...
CHECKS['privacy']['mailserver_locations']['longdesc'] = '''<p>We obtain the IP addresses of the mail server record(s) associated with the domain and look up its country in a GeoIP database. It is believed that personal data is protected better, if a website is hosted in a country that implements the European General Data Protection Directive (GDPR). We plan to offer more flexible geo-location tests in the future.</p>
<p><strong>Conditions for passing:</strong> The test passes if all IP addresses associated with the MX records are found to be in countries that implement the GDPR. This test is neutral if there are no MX records.</p>
